...
|:-:|---------|--------------|:-----:|:---:|:------:|
| **P1**  | 🌱 **HealthTrack AI v1**     | Health Data Platform — Apollo/AIIMS-style analytics + live deployment | L1 | 17 | 📋 Planned |
| **P2**  | 🌳 **HealthTrack AI v2** 🔄  | AI Health Assistant — v2.1 PostgreSQL · v2.2 FastAPI + ML · v2.3 AWS · v2.4 K8s | L1 → ∞ | 35 | 🔄 Living |
| **P3**  | 🌱 **NetGuard AI v1**        | Network Graph Analyzer — BFS + DFS + Dijkstra on corporate attack paths | L2 | 45 | 📋 Planned |
| **P4**  | 🌳 **NetGuard AI v2** 🔄     | Threat Intel Pipeline — v2.1 PostgreSQL · v2.2 ML · v2.3 AWS GuardDuty · v2.4 K8s | L2 → ∞ | 58 | 🔄 Living |
| **P5**  | 🌱 **FinVault AI v1**        | Financial Intelligence Platform — UPI/Zomato-style SQL analytics | L3 | 67 | 📋 Planned |
| **P6**  | 🌳 **FinVault AI v2** 🔄     | BFSI Production DB — v2.1 FastAPI + ML · v2.2 AWS RDS · v2.3 GenAI · v2.4 K8s + Vault | L3 → ∞ | 78 | 🔄 Living |
| **P7**  | 🌱 **RiskQuant AI v1**       | Quant Investment Engine — NSE portfolio + Markowitz + PCA from scratch | L4 | 93 | 📋 Planned |
| **P8**  | 🌳 **RiskQuant AI v2** 🔄    | Bayesian Risk Platform — v2.1 XGBoost + SHAP · v2.2 LSTM · v2.3 SageMaker · v2.4 MLflow | L4 → ∞ | 107 | 🔄 Living |
| **P9**  | 🌱 **FraudShield AI v1**     | Fraud Detection System — UPI fraud ML classifier + SHAP explainability | L5 | 122 | 📋 Planned |
| **P10** | 🌳 **FraudShield AI v2** 🔄  | Enterprise AI Platform — v2.1 CNN-LSTM · v2.2 SageMaker · v2.3 GenAI · v2.4 K8s | L5 → ∞ | 138 | 🔄 Living |
| **P11** | 🌱 **VisionCore AI v1**      | Computer Vision Platform — EfficientNet + FaceNet + Grad-CAM + ONNX | L7 | 163 | 📋 Planned |
| **P12** | 🌳 **VisionCore AI v2** 🔄   | Multi-Modal AI — 4 DL architectures: Transformer + CNN-LSTM + AE + GNN | L7 → ∞ | 178 | 🔄 Living |
...
graph TB
    ...
    subgraph SEC["🛡️ Security Layer"]
        SUR[SURAKSHA<br/>Network Defense]
        KAV[KAVACH<br/>Fraud Detection]
        SEN[SENTINEL<br/>Autonomous SOC]
    end

    subgraph DATA["💰 Data + Finance"]
        ART[ARTHIK<br/>Financial DB]
        NIV[NIVESH<br/>Quant Engine]
    end

    subgraph AI["🧠 AI + Vision"]
        AAR[AAROGYA<br/>Health AI]
        DRI[DRISHTI<br/>Multi-Modal]
        NYA[NYAYA<br/>Legal RAG]
    end

    subgraph OPS["⚙️ MLOps + Platform"]
        PRA[PRAHARI<br/>ML Monitor]
        SEN2[SentinelAI<br/>Unified]
    end
    ...
    style KING fill:#FF8C42,stroke:#fff,color:#fff,stroke-width:3px
...
<img src="https://img.shields.io/badge/XGBoost-EC1C24?style=flat-square&logo=xgboost&logoColor=white" alt="XGBoost"/>
...
<img src="https://github-readme-stats.vercel.app/api?username=dharunvishnu2006-ctrl&show_icons=true&hide_border=true&bg_color=0D1117&title_color=00CED1&icon_color=FF69B4&text_color=FFFFFF&count_private=true" alt="GitHub Stats" height="180"/>
<img src="https://github-readme-streak-stats.herokuapp.com?user=dharunvishnu2006-ctrl&hide_border=true&background=0D1117&stroke=8A2BE2&ring=00CED1&fire=FF8C42&currStreakLabel=00CED1&sideLabels=FF69B4&dates=FFFFFF&sideNums=FFFFFF&currStreakNum=FFFFFF" alt="GitHub Streak" height="180"/>

<br/>

<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=dharunvishnu2006-ctrl&layout=compact&hide_border=true&bg_color=0D1117&title_color=00CED1&text_color=FFFFFF" alt="Top Languages" height="180"/>
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:FF8C42,25:FF69B4,50:00CED1,75:1E90FF,100:8A2BE2&height=120&section=footer&text=Dedication%20%26%20Love%20%3E%20Any%20Degree&fontColor=ffffff&fontSize=22&fontAlignY=70&animation=fadeIn" alt="footer"/>
